export const content = {
  ar: {
    ...
    about: {
      ...
      activityText: "تشارك في العديد من المؤتمرات الدولية، وقدمت خبراتها في جلسات متخصصة تُناقش أحدث التطورات في علاج جفاف العين وتصحيح الإبصار.",
    ...
    media: {
      ...
      video1: "أسرار صحة العيون للأطفال والكبار: من النظارة الطبية إلى غرف العمليات",
      video2: "أضرار لا تُصدّق لـ المكياج على العين وخطورة نظارات الشمس غير المعروفة",
